## -string.h-
В данном репозитории представлена моя реализация библиотеки string.h. Со временем буду дополнять ее и приводить к полному соответсятвию с оригиналом.Будут добавлены реалиции функций sprintf и sscanf.(Пока добавил только sprintf.)
